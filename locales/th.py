...
STRINGS = {
    ...
    "monitoring_channel_not_found":      "❌ **Channel ID `{ch_id}`** ไม่พบในเซิร์ฟเวอร์นี้",
    "monitoring_channel_unsendable":     "❌ ช่อง `{name}` ไม่สามารถส่งข้อความได้",
    "monitoring_channel_numeric":        "❌ **Channel ID** ต้องเป็นตัวเลขเท่านั้น",
    "monitoring_log_channel_saved":      "📢 **Log Channel** → {mention}",
    "monitoring_health_interval_saved":  "🏥 **Health Interval** → {value} นาที",
    "monitoring_health_interval_range":  "❌ **Health Interval** ต้องอยู่ระหว่าง 1–60 นาที",
    "monitoring_health_interval_numeric":"❌ **Health Interval** ต้องเป็นตัวเลขเท่านั้น",
    "monitoring_alert_limit_saved":      "⏱️ **Alert Rate Limit** → {value} วินาที",
    "monitoring_alert_limit_range":      "❌ **Alert Rate Limit** ต้องอยู่ระหว่าง 30–3600 วินาที",
    "monitoring_alert_limit_numeric":    "❌ **Alert Rate Limit** ต้องเป็นตัวเลขเท่านั้น",
    "monitoring_enabled_saved_on":       "✅ **Monitoring** → เปิดใช้งาน ✓",
    "monitoring_enabled_saved_off":      "✅ **Monitoring** → ปิดใช้งาน ✗",
    "monitoring_enabled_boolean":        "❌ **Enable Monitoring** ต้องเป็น `true` หรือ `false`",
    "monitoring_no_changes":             "ℹ️ ไม่มีการเปลี่ยนแปลง — กรอกอย่างน้อยหนึ่งช่องเพื่อบันทึกการตั้งค่า",
    "monitoring_setup_results_title":    "🔧 Monitoring Setup — ผลลัพธ์",
    "monitoring_saved_header":           "✅ บันทึกสำเร็จ",
    "monitoring_errors_header":          "⚠️ พบข้อผิดพลาด",
    "monitoring_saved_supabase_footer":  "การตั้งค่าถูกบันทึกใน Supabase — มีผลทันที",
    "monitoring_save_error":             "❌ เกิดข้อผิดพลาดระหว่างบันทึก — ดู logs สำหรับรายละเอียด",
    "monitoring_status_title":           "📋 การตั้งค่า Monitoring",
    "monitoring_status_desc":            "การตั้งค่าปัจจุบันของเซิร์ฟเวอร์ **{guild}**",
    "monitoring_not_configured_hint":    "⚠️ ยังไม่ได้ตั้งค่า — ใช้ `/monitoring setup` เพื่อกำหนด",
    "monitoring_channel_not_found_display": "`{ch_id}` (ไม่พบช่อง)",
    "monitoring_status_channel_label":   "📢 Admin Log Channel",
    "monitoring_status_health_label":    "🏥 Health Check Interval",
    "monitoring_status_health_value":    "{value} นาที",
    "monitoring_status_rate_label":      "⏱️ Alert Rate Limit",
    "monitoring_status_rate_value":      "{value} วินาที",
    "monitoring_status_enabled_label":   "✅ Monitoring Enabled",
    "monitoring_status_active":          "เปิดใช้งาน ✓",
    "monitoring_status_inactive":        "ปิดใช้งาน ✗",
    "monitoring_status_footer":          "แก้ไขด้วย /monitoring setup · บันทึกใน Supabase",
    "monitoring_status_fetch_error":     "❌ ไม่สามารถดึงข้อมูลการตั้งค่าได้ — ดู logs สำหรับรายละเอียด",

    # ─── Health Embed ────────────────────────────────────────────────────────
    "health_status_title":       "🏥 สถานะสุขภาพบอท — {status}",
    "health_healthy":            "🟢 ปกติ",
    "health_degraded":           "🔴 ผิดปกติ",
    "health_uptime":             "เวลาทำงาน",
    "health_guilds":             "เซิร์ฟเวอร์",
    "health_discord_latency":    "ความหน่วง Discord",
    "health_database":           "🗄️ ฐานข้อมูล",
    "health_db_ping":            "Ping",
    "health_pool_size":          "ขนาด Pool",
    "health_system":             "💾 ระบบ",
    "health_memory":             "หน่วยความจำ",
    "health_loop_lag":           "Loop lag",
    "health_last_checked":       "ตรวจสอบล่าสุด",
    "health_db_unreachable":     "❌ เชื่อมต่อไม่ได้",
    "health_mem_unavailable":    "ไม่มีข้อมูล (ไม่ได้ติดตั้ง psutil)",
    "health_bot_label":          "🤖 บอท",

    # ─── Error Tracker Embed ─────────────────────────────────────────────────
    "error_report_title":        "🚨 รายงาน Error (24 ชั่วโมงล่าสุด)",
    "error_overview_label":      "📊 ภาพรวม",
    "error_total_errors":        "Error ทั้งหมด",
    "error_unique_types":        "ประเภท Error",
    "error_next_reset":          "รีเซ็ตครั้งถัดไป",
    "error_top_title":           "✅ สถานะ",
    "error_none_recorded":       "ไม่มี Error — ระบบปกติทุกอย่าง!",
    "error_last_seen":           "พบล่าสุด",
    "error_command":             "คำสั่ง",
    "error_user":                "ผู้ใช้",

    # ─── Command Stats Embed ─────────────────────────────────────────────────
    "cmdstats_title":            "📊 สถิติการใช้คำสั่ง",
    "cmdstats_overview_label":   "📈 ภาพรวม",
    "cmdstats_total_commands":   "การเรียกใช้ทั้งหมด",
    "cmdstats_failed":           "Error",
    "cmdstats_error_rate":       "อัตรา Error",
    "cmdstats_top_commands":     "🏆 คำสั่งยอดนิยม",
    "cmdstats_top_errors":       "⚠️ Error ที่พบบ่อย",
    "cmdstats_footer":           "สถิตินับตั้งแต่รีสตาร์ทล่าสุด",

    # ─── Analytics Field Labels ──────────────────────────────────────────────
    "analytics_field_score":     "🏆 คะแนนประสิทธิภาพ",
