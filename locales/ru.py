...
STRINGS = {
    ...
    # ─── UX/UI Additions ─────────────────────────────────────────────────────────
    'cat_no_category': '— Без категории',
    'cat_removed': '🗑️ Категория **{name}** удалена.',
    'setup_lang_field': '🌐 Язык',
    'stats_cancelled': 'Отменена',
    'priority_timeout': '⌛ Время выбора истекло. Пожалуйста, выполните команду снова.',
    'reminder_field_deadline': '📅 Дедлайн',
    'reminder_field_priority': '⚡ Приоритет',
    'reminder_field_task_id': '🆔 ID задачи',
    'dm_reminder_field_time_left': '⏱️ Осталось времени',
    'digest_stats_line': '📊 **{pending}** в процессе  ·  🚨 **{overdue}** просрочено',
    'help_overview_browse': 'Используйте меню ниже для выбора категории команд:\n• **📝 Управление задачами**: Создание, изменение, завершение и организация\n• **⚙️ Настройки и категории**: Часовой пояс, язык, категории\n• **💡 Советы и приемы**: Полезные рекомендации и умные функции',

    # ─── Productivity Analytics (/task-stats) ─────────────────────────────────────────────────────────
    'taskstats_title': '📊 Панель продуктивности  ·  {username}',
    'taskstats_overview_tab': '📊 Обзор',
    'taskstats_speed_tab': '⏱️ Скорость и своевременность',
    'taskstats_refresh': '🔄 Обновить',
    'taskstats_score_label': '🏆 Рейтинг продуктивности',
    'taskstats_score_value': '{score}/100  {badge}',
    'taskstats_completion_label': '✅ Процент выполнения',
    'taskstats_completion_value': '{rate}%  ({done}/{total} задач)',
    'taskstats_velocity_label': '⚡ Скорость выполнения',
    'taskstats_velocity_value': 'За 7 дней: **{v7}** задач  ·  За 30 дней: **{v30}** задач',
    'taskstats_streak_label': '🔥 Серия (Streak)',
    'taskstats_streak_value': '{days} дн. подряд',
    'taskstats_pending_overdue': '⏳ В процессе: **{pending}**  ·  🚨 Просрочено: **{overdue}**',
    'taskstats_speed_title': '⏱️ Анализ скорости и соблюдения сроков  ·  {username}',
    'taskstats_ontime_label': '✅ Выполнено вовремя',
    'taskstats_ontime_value': '{rate}%  ({count} задач)',
    'taskstats_late_label': '⚠️ Выполнено с опозданием',
    'taskstats_late_value': '{rate}%  ({count} задач)',
    'taskstats_turnaround_label': '⏰ Среднее время решения',
    'taskstats_turnaround_value': '{hours}',
    'taskstats_lead_label': '🚀 Средний запас времени (вовремя)',
    'taskstats_lead_value': '{hours} до дедлайна',
    'taskstats_lag_label': '🐌 Среднее опоздание (с задержкой)',
    'taskstats_lag_value': '{hours} после дедлайна',
    'taskstats_no_completed': 'Пока нет завершенных задач — выполните свою первую задачу сегодня! 🚀',
    'taskstats_tip_label': '💡 Персональный совет',
    'badge_master': '🏆 Мастер продуктивности',
    'badge_pro': '🎯 Профи пунктуальности',
    'badge_achiever': '🛡️ Уверенный деятель',
    'badge_rising': '⚡ Набирающий обороты',
    'badge_pacing': '🐢 Требуется фокус',
    'badge_new': '🌱 В начале пути',
    'tip_master': 'Потрясающе! Вы превосходите все ожидания. Самое время ставить ещё более амбициозные цели!',
    'tip_pro': 'Почти идеально! Попробуйте планировать на 10 минут вперед каждый день, чтобы улучшить результат.',
    'tip_achiever': 'Отличный темп! Добавляйте подзадачи к крупным делам для ускорения рабочего процесса.',
    'tip_rising': 'Хороший разгон! Сортируйте задачи по приоритету, чтобы лучше фокусироваться.',
    'tip_pacing': 'Не переживайте! Разбивайте большие задачи на маленькие и выделяйте время каждый день.',
    'tip_new': 'Вперед! Добавьте первую задачу командой `/add` и завершите её уже сегодня! 💪',
    'duration_days': '{d}д {h}ч',
    'duration_hours': '{h}ч {m}м',
    'duration_mins': '{m}м',
    'duration_na': 'Нет данных',

    # ─── On-Demand /digest command ─────────────────────────────────────────────────────────
    'digest_cmd_desc': '☀️ Мгновенно просмотреть сводку задач на сегодня',
    'digest_btn_list': '📋 Все задачи',
    'digest_btn_add': '➕ Добавить задачу',
    'digest_btn_refresh': '🔄 Обновить',

    # ─── Conflict Resolution & Defensive Programming ─────────────────────────────────────────────────────────
    'task_past_deadline_detailed': '❌ Дедлайн должен быть в будущем.\n🕒 Ваше текущее время: **{current_time}**\n📅 Указанное время: **{input_time}**',
    'task_invalid_year': '❌ Указанный год выходит за допустимый диапазон (2000 – текущий год +10).',
    'subtask_deadline_exceeds_parent': '❌ Дедлайн подзадачи ({subtask_dl}) не может быть позже дедлайна основной задачи ({parent_dl}).',
    'subtask_parent_closed': '❌ Нельзя добавить подзадачу к уже выполненной или отмененной задаче.',
    'conflict_duplicate_title': '⚠️ Обнаружен конфликт: Задача с таким именем уже существует',
    'conflict_duplicate_desc': 'Уже есть активная задача с именем **"{existing_name}"** (ID: **#{existing_id}**).\nТекущий дедлайн: **{existing_deadline}**\n\nКак вы хотите поступить?',
    'btn_conflict_autorename': '🏷️ Сохранить как "{new_name}"',
    'btn_conflict_force': '⚡ Создать в любом случае',
    'btn_conflict_view': '🔍 Посмотреть существующую задачу',
    'btn_conflict_cancel': '❌ Отмена',
    'conflict_cancelled': '❌ Создание задачи отменено.',
    'conflict_autorename_done': '✅ Задача сохранена как **"{new_name}"**! ID: **#{task_id}**',
    'edit_past_deadline_blocked': '❌ Нельзя установить дедлайн в прошлом.\n🕒 Ваше текущее время: **{current_time}**\n📅 Указанное время: **{input_time}**',
}
