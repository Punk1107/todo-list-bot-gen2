...
STRINGS = {
    ...
    'task_past_deadline_detailed': '❌ Die Frist muss in der Zukunft liegen.\n🕒 Deine aktuelle Zeit: **{current_time}**\n📅 Eingegebene Zeit: **{input_time}**',
    'task_invalid_year': '❌ Das angegebene Jahr liegt außerhalb des gültigen Bereichs (2000 – aktuelles Jahr +10).',
    'subtask_deadline_exceeds_parent': '❌ Die Frist der Unteraufgabe ({subtask_dl}) darf nicht später als die der Hauptaufgabe sein ({parent_dl}).',
    ...
    'conflict_duplicate_desc': 'Eine ausstehende Aufgabe namens **"{existing_name}"** (ID: **#{existing_id}**) existiert bereits.\nBestehende Frist: **{existing_deadline}**\n\nWie möchtest du vorgehen?',
    ...
    'edit_past_deadline_blocked': '❌ Die Frist kann nicht in der Vergangenheit liegen.\n🕒 Deine aktuelle Zeit: **{current_time}**\n📅 Eingegebene Zeit: **{input_time}**',
}
